<div class="container-fluid jarak-section">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="navigasi">
        <a href="?halaman=wisata_alam" class="nav-cust">Alam</a>
        <a href="?halaman=wisata_buatan" class="nav-cust">Buatan</a>
        <a href="?halaman=wisata_religi" class="nav-custActive">Religi</a>
      </div>
    </div>
  </div>
</div>
